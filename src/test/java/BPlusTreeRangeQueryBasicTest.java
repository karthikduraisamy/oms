...
public class BPlusTreeRangeQueryBasicTest {

    private static final Logger log = Logger.getLogger(BPlusTreeRangeQueryBasicTest.class);
    ...
    public void setUp() throws DataThresholdException, InvalidRangeException {
        ...
        testData = new long[]{10, 12, 17, 21, 2, 15, 16};
         rf = new BinaryPlusTreeRangeContainerFactory();
