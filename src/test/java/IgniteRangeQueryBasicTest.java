...
import com.workday.oms.impl.ignite.IgniteRangeContainerFactory;
...
public class IgniteRangeQueryBasicTest {

    private static final Logger log = Logger.getLogger(IgniteRangeQueryBasicTest.class);
    ...
    public void setUp() throws DataThresholdException, InvalidRangeException {
        ...
        rf = new IgniteRangeContainerFactory();
