...
public class TreeMapRangeQueryBasicTest {

    private static final Logger log = Logger.getLogger(TreeMapRangeQueryBasicTest.class);
    ...
    public void setUp() throws DataThresholdException, InvalidRangeException {
        ...
        rf = new TreeMapRangeContainerFactory();
